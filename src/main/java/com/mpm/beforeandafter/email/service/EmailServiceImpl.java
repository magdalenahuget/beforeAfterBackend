...
//                        contactFormDto.senderEmail(),
//                        recipientEmail,
//                        "Subject",
//                        contactFormDto.emailContent()
//                );
//
//                javaMailSender.send(mimeMessage);
//                logEmail(recipientEmail, "New Contact Form Submission", LocalDateTime.now(), true, null);
//                return new EmailResponseDto(true);
//
//            } catch (MessagingException e) {
//                logEmail(recipientEmail, "New Contact Form Submission", LocalDateTime.now(), false, e.getMessage());
...
//        message.setText(content, true); //z HTML content
//        return mimeMessage;
//    }
//
